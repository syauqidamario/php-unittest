...
class MathTest extends TestCase
{
       ...
       */
      public function testDataProvider(array $val, int $expected)
      {
            self::assertEquals($expected, Math::sum($val));
      }
      ...
      //Dengan @testWith, data bisa dikirim ke unit test tanpa membuat function
      //Cukup dimasukkan di doc saja
